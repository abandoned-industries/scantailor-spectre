...
GrayImage scaleToGray(const GrayImage& src, const QSize& dstSize) {
  ...
  // Do not substitute vImageScale here: vImage resamples with Lanczos, whose
  // ringing violates the area-average contract that EstimateBackground,
  // PageLayoutEstimator and the dewarping tracers depend on.
