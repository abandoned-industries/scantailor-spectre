...
class Settings {
 ...
 public:
  ...
  // Language code (empty = fast system default, "auto" = multilingual detection)
  ...
  bool useLanguageCorrection() const;
  void setUseLanguageCorrection(bool enabled);
 ...
 private:
  ...
  QString m_language;         // Empty = fast system-language default
  bool m_useAccurateRecognition = true;
  bool m_useLanguageCorrection = true;
