...
class OptionsWidget : public FilterOptionsWidget, private Ui::OcrOptionsWidget {
 ...
 private slots:
  ...
  void fastOcrChanged(bool checked);
  void multilingualChanged(bool checked);
  void skipLanguageCorrectionChanged(bool checked);
 ...
 private:
  ...
  PageId m_pageId;
  QString m_languageBeforeMultilingual;
};
}  // namespace ocr
